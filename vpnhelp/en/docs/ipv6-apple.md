...
# Tutorial for Enabling IPv6 on iOS

1. Download the profile specific to your operator by clicking on one of the links below:
...
2. A window will open; select "Allow."
...
3. Now go to your phone's Settings and select "General."
...
4. On the next page, select "VPN & Device Management." The profile you downloaded will be displayed. Select it.
...
5. Then click "Install" and enter your password.
...
6. Follow the images below and select "Next" and "Install" on the new pages.
...
7. When you see this page, you're done. Simply select "Done." Toggle Airplane Mode on and off once.
Congratulations :) Enjoy IPv6.
